        ...
        return (
            <div className="FaqSection-container">
                ...
                <div className="FaqSection-regulamento">
                    ...
                    <p>Basta fazer o cadastro na plataforma e esperar a data de início para poder fazer as apostas. Também é necessário entrar em contato com um dos representantes do bolão, como informado no <Link to="/">Regulamento</Link>.</p>

                    <h3>Quais prêmios posso ganhar?</h3>
                    <p>O objetivo da plataforma é promover o entretenimento e a diversão com os amigos durante as competições. Os prêmios são definidos de acordo com a quantidade de participantes. Leia o <Link to="/">Regulamento</Link> para saber mais!</p>
                </div>
            </div>
        );
    }
