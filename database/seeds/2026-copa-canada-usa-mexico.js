...
exports.seed = async function (knex) {
  ...
  await knex('part').insert([
    ...
    { name: 'Grupo I', status: 'finalizado', fkPhaseId: fase1, },
    { name: 'Grupo J', status: 'finalizado', fkPhaseId: fase1, },
    { name: 'Grupo K', status: 'finalizado', fkPhaseId: fase1, },
    { name: 'Grupo L', status: 'finalizado', fkPhaseId: fase1, },
    { name: 'Segunda Fase', status: 'finalizado', fkPhaseId: fase2, },
