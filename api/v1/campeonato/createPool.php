...
$pool = new Pool();
$poolCreated = $pool->create($reqBody->poolInfo);
$pool->joinParts($poolCreated['id'], $reqBody->partsSelected);

$poolInfo = $pool->get($poolCreated['uuid']);
$poolChampionshipInfo = $pool->getPoolChampionshipInfoBetter($poolCreated['id']);
