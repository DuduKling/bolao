...
$fixtureId = htmlspecialchars(strip_tags($reqBody->fixtureId));
...
$fixture = $pool->getPoolFixture($poolUuid, $fixtureId);
$fixtureBets = $pool->getFixtureBets($poolData['id'], $fixtureId);
